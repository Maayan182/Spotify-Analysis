...
**To see the complete report including the code for the analysis in jupyter notebook click [here](https://nbviewer.org/github/Maayan182/Spotify-Analysis/blob/main/Analysis.ipynb) to go to nbviewer**  
## Table of Contents   
